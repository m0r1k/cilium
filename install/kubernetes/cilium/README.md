...
![Version: 1.17.0-rc.0](https://img.shields.io/badge/Version-1.17.0--rc.0-informational?style=flat-square) ![AppVersion: 1.17.0-rc.0](https://img.shields.io/badge/AppVersion-1.17.0--rc.0-informational?style=flat-square)
...
| authentication.mutual.spire.install.initImage | object | `{"digest":"sha256:2919d0172f7524b2d8df9e50066a682669e6d170ac0f6a49676d54358fe970b5","override":null,"pullPolicy":"IfNotPresent","repository":"docker.io/library/busybox","tag":"1.37.0","useDigest":true}` | init container image of SPIRE agent and server |
...
| clustermesh.apiserver.image | object | `{"digest":"sha256:f02419adf8265518f464a15a5434cbdab870b60930a2f0017a3bd0d9cd6f77d7","override":null,"pullPolicy":"IfNotPresent","repository":"quay.io/cilium/clustermesh-apiserver","tag":"v1.17.0-rc.0","useDigest":true}` | Clustermesh API server image. |
...
| envoy.image | object | `{"digest":"sha256:9eecb1bcab31c76cb42209e51b446c24e7b7a541c36055db1efb952454396455","override":null,"pullPolicy":"IfNotPresent","repository":"quay.io/cilium/cilium-envoy","tag":"v1.31.5-1734560092-afaf1ff01f1c3ba75a0f9bc9e5a34712a29a8bc3","useDigest":true}` | Envoy container image. |
...
| hubble.relay.image | object | `{"digest":"sha256:ecf1a7133c73603a59dacabb2ca3756b938465bc05d78396e3bca3afd63b90ed","override":null,"pullPolicy":"IfNotPresent","repository":"quay.io/cilium/hubble-relay","tag":"v1.17.0-rc.0","useDigest":true}` | Hubble-relay container image. |
...
| image | object | `{"digest":"sha256:fd460ee60e3d5dc785128539aa4cf7e2f797b994602d27ec69146eb50fbf4b95","override":null,"pullPolicy":"IfNotPresent","repository":"quay.io/cilium/cilium","tag":"v1.17.0-rc.0","useDigest":true}` | Agent container image. |
...
| operator.image | object | `{"alibabacloudDigest":"sha256:296eadb324441538049996ae3a780db1ac909d98c9f820fdeee110023fbf3a94","awsDigest":"sha256:f204409d9fb9e176a062c16eb9f6c564bbed450b06409f3f2afe9cbddb9af8fe","azureDigest":"sha256:9e77740f394b0ec27c6a51f6bee239e40fc9f5b3cd70bd7bcc4244c1ad538ea7","genericDigest":"sha256:2b60ecc195ed929113e49d648aad491981153693a905bff93d5939f93c97bd8f","override":null,"pullPolicy":"IfNotPresent","repository":"quay.io/cilium/operator","suffix":"","tag":"v1.17.0-rc.0","useDigest":true}` | cilium-operator image. |
...
| preflight.image | object | `{"digest":"sha256:fd460ee60e3d5dc785128539aa4cf7e2f797b994602d27ec69146eb50fbf4b95","override":null,"pullPolicy":"IfNotPresent","repository":"quay.io/cilium/cilium","tag":"v1.17.0-rc.0","useDigest":true}` | Cilium pre-flight image. |
